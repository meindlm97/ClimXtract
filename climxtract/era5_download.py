    ...
    if os.path.exists(output_file):
        ...
        if variable == 'pr' and model_global == 'reanalysis-era5-single-levels':
            ...
            for day in dates:
                ...
                pr_d = dataset.pr.sel(valid_time=slice(day + np.timedelta64(1, 'h'), day + np.timedelta64(23, 'h')))

                # Select 00 UTC of day `d+1` (this is hour 24 of day `d`)
                pr_d1_00 = dataset.pr.sel(valid_time=day + np.timedelta64(1, 'D'))  # 00 UTC next day
